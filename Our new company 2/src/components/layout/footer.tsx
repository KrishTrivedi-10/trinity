...
export default function Footer() {
  return (
    <footer style={{ background: '#FAF8F5', borderTop: '1px solid var(--border)' }}>
      ...
      {/* ── Newsletter Band ── */}
      <div style={{ background: 'var(--maroon)', padding: '5rem 0' }}>
        <div className="container">
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.65)', fontWeight: 300, lineHeight: 1.8, maxWidth: '420px' }}>
      ...
      {/* ── Main Footer Grid ── */}
      <div className="container" style={{ padding: '5rem 0 3rem' }}>
        <div style={{
          display: 'grid',
          ...
          >
            <Link to="/" className="nav-brand" style={{ marginBottom: '1.5rem', display: 'inline-flex' }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span className="nav-brand-name" style={{ fontSize: '1.6rem' }}>Trinity Vaastu</span>
          ...
          >
            <h4 style={{ fontSize: '0.7rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-main)', fontWeight: 700, marginBottom: '1.5rem' }}>
              Explore
            </h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
              {[
                ...
                <Link key={link.path} to={link.path} style={{ fontSize: '0.9rem', color: 'var(--text-muted)', fontWeight: 400, transition: 'color 0.2s' }}>
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
              {[
                { Icon: Phone, text: '+91-9999051719' },
                { Icon: Mail, text: 'info@trinityvaastu.com' },
                ...
                <div key={text} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <div style={{
                    ...
                    height: '32px',
                    borderRadius: '50%',
                    background: 'rgba(200,150,27,0.08)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    color: 'var(--gold)',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '2rem' }}>
            {[
              ...
              <Link key={link.path} to={link.path} style={{ fontSize: '0.82rem', color: 'var(--text-muted)' }}>
                {link.label}
              </Link>
            ))}
          </div>
